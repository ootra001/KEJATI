		...
		<form name="idbidang" method="POST" class="form-horizontal" onchange="idbidang.submit()">
					 ...
					 <div class="control-group">
						...
						<select class="span3" name="bidang">
							<OPTION>--</OPTION>
						<?php
			...
			<form action="modul/nilai/aksi_nilai.php" method="POST" class="form-horizontal">
				<fieldset>
				 <?php 

				 	if(isset($_POST['bidang'])){
				 			$query="SELECT * FROM bidang where id='$_POST[bidang]'";
							$hasil=mysqli_query($konek,$query);
				 		...
				 		if($_POST['bidang']=="5"){
				 			...
				 			<input type="hidden" name="bidang" value="'.$_POST['bidang'].'">	
